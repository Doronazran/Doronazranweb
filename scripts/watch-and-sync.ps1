...
# seconds after you stop editing. Leave it running in a terminal (or start it at
# logon via install-auto-sync.ps1 -RealTime).
...
Write-Host "Watching '$Watch' for changes. Will auto-push $Debounce s after you stop editing. (Ctrl+C to stop)" -ForegroundColor Cyan
